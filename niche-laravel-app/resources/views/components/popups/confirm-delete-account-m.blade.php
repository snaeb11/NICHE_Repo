  ...
  <div class="w-[25vw] max-h-[48vh] bg-[#fffff0] rounded-2xl shadow-xl relative p-8">
    ...
    <div id="cda-step1">
      ...
      <div class="flex justify-center space-x-6 mt-10">
        <button id="cda-cancel-btn1" class="w-[7vw] h-[5vh] rounded-full text-[#fffff0] bg-gradient-to-r from-[#A4A2A2] to-[#575757] hover:from-[#cccaca] hover:to-[#888888]">
          Cancel
        </button>
        <button id="cda-next-step1" class="w-[7vw] h-[5vh] rounded-full text-[#fffff0] bg-gradient-to-r from-[#FE5252] to-[#E10C0C] hover:from-[#f87c7c] hover:to-[#e76969]">
          Confirm
        </button>
      </div>
    </div>
    ...
    <div id="cda-step2" class="hidden">
      ...
      <div class="flex justify-center mt-10">
        <button id="cda-final-close" class="w-[7vw] h-[5vh] rounded-full text-[#fffff0] bg-gradient-to-r from-[#A4A2A2] to-[#575757] hover:from-[#cccaca] hover:to-[#888888]">
          Close
        </button>
      </div>
    </div>
