...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        resendButton.addEventListener('click', async function() {
            ...
            try {
                const response = await fetch("<?php echo e(route('verification.resend')); ?>", {
                    method: "POST",
                    headers: {
    ...
    `;
            ...
            fetch("<?php echo e(route('verify.code')); ?>", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json",
                        "X-CSRF-TOKEN": "<?php echo e(csrf_token()); ?>",
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/popups/first-time-user-login.blade.php ENDPATH**/ ?>