    ...
    <div id="pt-step-1" class="flex justify-center">
      <div class="flex flex-col items-center w-[50vw] h-[30vh] rounded-xl border-dashed">
        <div class="flex flex-col items-center w-[20vw] h-[200vh] border-[1px] border-dashed border-[#575757] rounded-xl">
          ...
          <button id="pt-browse-btn-1" class="w-[5vw] h-[5vh] rounded-[10px] bg-[#fffff0] text-[#575757] font-semibold hover:brightness-95 border-[1px] border-[#575757] mt-15 hover:cursor-pointer transition-all duration-200">
            Browse
          </button>
        ...
        <div class="flex justify-center space-x-6 mt-10">
          <button id="pt-cancel-btn" class="w-[7vw] h-[5vh] rounded-full text-[#fffff0] bg-gradient-to-r from-[#A4A2A2] to-[#575757] hover:from-[#cccaca] hover:to-[#888888] hover: cursor-pointer transition-all duration-200">
            Cancel
          </button>
        </div>
      </div>
    ...
    <div id="pt-step-2" class="hidden justify-center h-[225px]">
      <div class="flex flex-col items-center w-[50vw] h-[30vh] rounded-xl border-dashed">
        <div class="flex flex-col items-center w-[20vw] h-[200vh] border-[1px] border-dashed border-[#575757] rounded-xl">
          ...
          <button id="pt-browse-btn-2" class="w-[5vw] h-[5vh] rounded-[10px] bg-[#fffff0] text-[#575757] font-semibold hover:brightness-95 hover: cursor-pointer transition-all duration-200 border-[1px] border-[#575757] mt-15">
            Browse Again
          </button>
        ...
        <!-- Buttons -->
        <div class="flex justify-center space-x-6 mt-10">
          <button id="pt-cancel-btn1" class="w-[7vw] h-[5vh] rounded-full text-[#fffff0] bg-gradient-to-r from-[#A4A2A2] to-[#575757] hover:from-[#cccaca] hover:to-[#888888] hover:cursor-pointer transition-all duration-200">
            Cancel
          </button>
          <button id="pt-confirm-btn" class="w-[7vw] h-[5vh] rounded-full text-[#fffff0] bg-gradient-to-r from-[#28CA0E] to-[#1BA104] hover:from-[#3ceb22] hover:to-[#2db415] cursor-pointer transition-all duration-200">
            Confirm
          </button>
        </div>
      </div>
