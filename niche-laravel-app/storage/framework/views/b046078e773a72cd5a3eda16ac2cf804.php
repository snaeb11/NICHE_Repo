...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        <?php if(session('account_created')): ?>
            ...
            <?php endif; ?>
            <?php if(session('account_email')): ?>
                const rawEmail = <?php echo json_encode(session('account_email'), 15, 512) ?>;
                if (emailSpan) {
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/popups/account-creation-successful-m.blade.php ENDPATH**/ ?>