...
<script>
    ...
    `;
            ...
            try {
                const response = await fetch('<?php echo e(route('account.deactivate')); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/popups/confirm-deactivation-m.blade.php ENDPATH**/ ?>