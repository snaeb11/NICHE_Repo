<div id="universal-x-popup" style="display: none;" class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
    <div id="x-popup" class="min-w-[20vw] max-w-[25vw] max-h-[90vh] bg-[#fdfdfd] rounded-2xl shadow-xl relative p-8 block">
        ...
        <div class="mt-20 flex justify-center">
            <button id="uniX-confirm-btn" class="px-10 py-4 rounded-full text-[#fdfdfd] bg-gradient-to-r from-[#FE5252] to-[#E10C0C] shadow hover:brightness-110 cursor-pointer">
                Confirm
            </button>
        </div>
    </div>
