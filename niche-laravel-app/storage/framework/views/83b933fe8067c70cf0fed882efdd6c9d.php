...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('signup.store')); ?>" class="-mt-8 flex w-full flex-grow items-center justify-center">
        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            <?php if(session('account_created')): ?>
                ...
                <?php if(session('account_name')): ?>
                    nameSpan.textContent = <?php echo json_encode(session('account_name'), 15, 512) ?>;
                <?php endif; ?>
                ...
                document.getElementById('acs-confirm-btn').addEventListener('click', function() {
                    ...
                    <?php if(session('show_verification')): ?>
...
<?php echo $__env->make('layouts.template.base', ['cssClass' => 'bg-[#fdfdfd]'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/layouts/auth/signup.blade.php ENDPATH**/ ?>