<div id="universal-ok-popup" style="display: none;" class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
    <div id="ok-popup" class="min-w-[20vw] max-w-[25vw] max-h-[90vh] bg-[#fdfdfd] rounded-2xl shadow-xl relative p-8 block">
        ...
        <div class="text-center text-xl font-semibold mt-10">
            <span id="OKtopText" class="text-[#575757]">Successfully Changed Account Details!</span>
        </div>

        <div class="text-center mt-5 text-normal font-regular">
            <span id="OKsubText" class="text-[#575757]">Successfully altered this account’s information.</span>
        </div>

        <div class="mt-20 flex justify-center">
            <button id="uniOK-confirm-btn" class="px-10 py-4 rounded-full text-[#fdfdfd] bg-gradient-to-r from-[#27C50D] to-[#1CA506] shadow hover:brightness-110 cursor-pointer">
                Confirm
            </button>
        </div>
    </div>
