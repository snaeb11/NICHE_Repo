<div id="user-edit-acc-fail" style="display: none;"
    ...
    <div class="relative max-h-[90vh] min-w-[21vw] max-w-[25vw] rounded-2xl bg-[#fdfdfd] p-8 shadow-xl">
        ...
        <div class="mt-10 text-center text-xl font-semibold">
            <span class="text-[#575757]">Failed to update profile!</span>
        </div>
        <div id="user-edit-acc-fail-message" class="mt-4 text-center text-sm text-[#575757]">
            <!-- Error message will be inserted here -->
        </div>
        <div class="mt-13 flex justify-center">
            <button onclick="document.getElementById('user-edit-acc-fail').style.display = 'none'"
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/popups/user-edit-acc-fail.blade.php ENDPATH**/ ?>