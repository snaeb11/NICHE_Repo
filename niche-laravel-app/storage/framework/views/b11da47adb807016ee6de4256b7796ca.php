...
<main id="forms-submission-table"
    ...
    <div class="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <?php if(auth()->user() && auth()->user()->hasPermission('view-forms-submissions')): ?>
            <div class="w-full">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-[#fdfdfd]">
                <tr>
                    ...
                    <?php if(auth()->user() && auth()->user()->hasPermission('acc-rej-forms-submissions')): ?>
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/admin-pages/forms-submission-page.blade.php ENDPATH**/ ?>