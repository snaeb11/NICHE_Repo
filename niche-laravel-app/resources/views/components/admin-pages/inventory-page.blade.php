            ...
            <div
                ...
                <div class="flex flex-col w-full  md:col-start-2 md:row-start-2 md:row-span-2">
                    ...
                    <textarea name="abstract" id="abstract" placeholder="Abstract"
                        class="w-full min-h-[41vh] rounded-[10px] border border-[#c2c2c2] mt-5 px-4 py-2 font-light text-[#575757] placeholder-[#575757] resize-none transition-colors duration-200 focus:border-[#D56C6C] focus:outline-none"></textarea>
                ...
                <div class="flex flex-col w-full  md:col-start-2 md:row-start-5">
                    <div class="flex justify-end mt-10">
                        <button id="submit-inventory"
                            class="px-6 py-3 rounded-lg bg-[#4CAF50] text-white hover:brightness-110">Submit</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="border-[#c2c2c2] border-1 rounded-xl p-10 pt-0 flex justify-center">
            <div
                ...
                <div class="flex flex-col w-full md:col-start-1 md:row-start-1">
                    ...
                    <!-- Textarea -->
                    <textarea name="edit-title" id="edit-thesis-title" placeholder="Thesis title"
                        class="w-full min-h-[5vh] rounded-[10px] border border-[#c2c2c2] mt-5 px-4 py-2 font-light text-[#575757] placeholder-[#575757] resize-none transition-colors duration-200 focus:border-[#D56C6C] focus:outline-none"></textarea>
                ...
                <div class="flex flex-col w-full  md:col-start-1 md:row-start-4">
                    <span class="text-[#575757] font-semibold text-2xl">School Year</span>
                    <div class="relative">
                        <select name="edit-academic_year"
                            class="w-full min-h-[45px] rounded-[10px] border border-[#c2c2c2] mt-5 px-4 py-2 text-[#575757] font-light focus:border-[#D56C6C] focus:outline-none appearance-none"
                            required>
                            <option value="" disabled selected>Select year</option>
                            @for ($year = 2025; $year >= 1990; $year--)
                ...
                <div class="flex flex-col w-full  md:col-start-2 md:row-start-1">
                    ...
                    <!-- Textarea -->
                    <textarea name="edit-authors" id="edit-authors" placeholder="Authors"
                        class="w-full min-h-[5vh] rounded-[10px] border border-[#c2c2c2] mt-5 px-4 py-2 font-light text-[#575757] placeholder-[#575757] resize-none transition-colors duration-200 focus:border-[#D56C6C] focus:outline-none"></textarea>
                </div>
                ...
                <div class="flex flex-col w-full  md:col-start-2 md:row-start-2 md:row-span-2">
                    ...
                    <!-- Textarea -->
                    <textarea name="edit-abstract" id="edit-abstract" placeholder="Abstract"
                        class="w-full min-h-[41vh] rounded-[10px] border border-[#c2c2c2] mt-5 px-4 py-2 font-light text-[#575757] placeholder-[#575757] resize-none transition-colors duration-200 focus:border-[#D56C6C] focus:outline-none"></textarea>
                ...
                <div class="flex flex-col w-full  md:col-start-2 md:row-start-5">
                    <div class="flex justify-end mt-10">
                        <button id="edit-submit-inventory"
                            class="px-6 py-3 rounded-lg bg-[#4CAF50] text-white hover:brightness-110 cursor-pointer">Submit</button>
                    </div>
                </div>
            </div>
        </div>
