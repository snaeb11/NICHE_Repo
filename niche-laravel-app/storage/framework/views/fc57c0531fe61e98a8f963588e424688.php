...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo $__env->yieldContent('title', 'CTET-CTSuL Inventory System'); ?></title>
        <style>
            body {
                margin: 0;
                padding: 0;
    ...
    <body>
        <div class="email-container">
            <!-- Header -->
            <div class="header">
                <h1 class="header-title"><?php echo $__env->yieldContent('header-title', 'CTET-CTSuL Inventory System'); ?></h1>
            </div>
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/emails/layouts/base.blade.php ENDPATH**/ ?>