...
<main id="submission-table" class="ml-[4vw] hidden p-8 transition-all duration-300 ease-in-out group-hover:ml-[18vw]">
    <div class="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <?php if(auth()->user() && auth()->user()->hasPermission('view-thesis-submissions')): ?>
            <div class="w-full">
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/admin-pages/theses-submission-page.blade.php ENDPATH**/ ?>