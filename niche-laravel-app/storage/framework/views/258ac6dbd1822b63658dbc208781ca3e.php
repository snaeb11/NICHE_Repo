...
<script>
    ...
    document.getElementById('ef-export-btn').addEventListener('click', function() {
        ...
        switch (selectedType) {
            case 'docx':
                url = '<?php echo e(route('inventory.export.docx')); ?>';
                break;
            case 'excel':
                url = '<?php echo e(route('inventory.export.excel')); ?>';
                break;
            case 'pdf':
                url = '<?php echo e(route('inventory.export.pdf')); ?>';
                break;
            default:
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/popups/export-file-m.blade.php ENDPATH**/ ?>