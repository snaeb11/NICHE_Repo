<div id="admin-ftl-changepass" style="display: none;" class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
    <div class="border-1 rounded-2xl bg-[#fdfdfd] border-[#a1a1a1] relative p-10">
        <button id="admin-ftl-close-popup" class="absolute top-4 right-4 text-[#575757] hover:text-red-500">
        ...
        <form id="ftl-password-change-form" method="POST">
            ...
            <div class="flex flex-col gap-6 px-6 md:flex-row">
                ...
                <div id="input-fields" class="flex w-full flex-col space-y-4 md:w-1/2">
                        ...
                        <input id="ftl-new-password" name="new_password" type="password" placeholder="New password"
                            required
                            class="h-[50px] rounded-[10px] border border-[#575757] px-4 font-light text-[#575757] placeholder-[#575757] transition-colors duration-200 focus:outline-none" />
                        ...
                        <label
                            ...
                            <input type="checkbox" id="ftl-show-password-toggle" class="h-4 w-4 accent-[#575757] hover:cursor-pointer" />
