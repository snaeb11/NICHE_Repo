...
<div class="w-[10%] md:w-[15%] flex items-center justify-betweenp-2">
        ...
        <div
            ...
            <aside id="logo-sidebar" class="h-full px-3 py-4 text-white">
                <div class="flex items-center space-x-3 text-[#fffff0]">
                    ...
                    <div class="flex space-x-2 edit-admin">
                        <div
                            class="invisible opacity-0 whitespace-nowrap transition-opacity duration-300 delay-100 group-hover:visible group-hover:opacity-100 w-40">
                            <a href="#"
                                class="username-admin block font-semibold hover:underline break-words whitespace-normal">User
                                Name</a>
...
<div id="mobile-sidebar"
    class="fixed left-0 top-0 z-50 h-screen w-70 -translate-x-full transform bg-gradient-to-b from-[#D56C6C] to-[#C96262] transition-transform duration-300 md:hidden"
    ...
    <aside class="h-full  px-3 py-4 text-white">
        <aside id="logo-sidebar" class="h-full px-3 py-4 text-white">
            <div class="flex items-center space-x-3 text-[#fffff0]">
                ...
                <div class="flex space-x-1 edit-admin">
                    <div class="ms-3 whitespace-normal transition-opacity duration-300 w-40">
                        <a href="#"
                            class="username-admin block font-semibold break-words whitespace-normal hover:underline">User
                            Name</a>
                        <div class="text-sm font-light">Admin Title</div>
                    </div>
                    <button type="button"
