  ...
  <div class="w-[523px] h-[473px] bg-[#fffff0] rounded-2xl shadow-xl relative p-8">
    ...
    <div id="cdr-step1">
      ...
      <div class="flex justify-center space-x-6 mt-10">
        <button id="cdr-cancel-btn1" class="w-[175px] h-[66px] rounded-full text-[#fffff0] bg-gradient-to-r from-[#A4A2A2] to-[#575757] hover:from-[#cccaca] hover:to-[#888888]">
          Cancel
        </button>
        <button id="cdr-next-step1" class="w-[175px] h-[66px] rounded-full text-[#fffff0] bg-gradient-to-r from-[#FE5252] to-[#E10C0C] hover:from-[#f87c7c] hover:to-[#e76969]">
          Confirm
        </button>
      </div>
    </div>
    ...
    <div id="cdr-step2" class="hidden">
      ...
      <div class="flex justify-center mt-10">
        <button id="cdr-final-close1" class="w-[175px] h-[66px] rounded-full text-[#fffff0] bg-gradient-to-r from-[#A4A2A2] to-[#575757] hover:from-[#cccaca] hover:to-[#888888]">
          Close
        </button>
      </div>
    </div>
