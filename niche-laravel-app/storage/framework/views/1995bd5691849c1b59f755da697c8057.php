...
<nav class="z-50 border-b border-b-[#dddddd] bg-[#fdfdfd] shadow-sm">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-24">
        ...
        <div class="flex items-center space-x-3">
            <!-- Circle Logos -->
            <a href="<?php echo e(url('/')); ?>" class="flex h-8 w-8 items-center justify-center rounded-full bg-[#575757]">
                <img src="<?php echo e(asset('assets/usep-logo.png')); ?>" alt="USeP Logo"
            ...
            <a href="<?php echo e(url('/')); ?>" class="flex h-8 w-8 items-center justify-center rounded-full bg-[#575757]">
                <img src="<?php echo e(asset('assets/ctet-logo.png')); ?>" alt="CTET Logo"
                    class="h-full w-full rounded-full object-cover" />
            </a>

            <!-- Text -->
            <a href="<?php echo e(url('/')); ?>" class="flex-col sm:flex">
    ...
    <div id="mobile-menu" class="hidden px-4 pb-4 mt-3 md:hidden">
        <div class="space-y-2">
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(url('/')); ?>" class="block text-sm font-semibold text-[#575757] hover:text-[#9D3E3E]">
                    Home
                </a>
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/layout-partials/header.blade.php ENDPATH**/ ?>