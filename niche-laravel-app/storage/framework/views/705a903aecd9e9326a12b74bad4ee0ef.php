...
<nav class="z-50 border-b border-b-[#dddddd] bg-[#fdfdfd] shadow-sm">
    <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-24">
        ...
        <div class="hidden space-x-5 md:flex">
            <a href="<?php echo e(route('home')); ?>"
                class="<?php echo e(Route::currentRouteName() === 'home' ? 'underline text-[#9D3E3E]' : 'hover:text-[#9D3E3E]'); ?> text-sm font-semibold">
                Home
            </a>
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->account_type !== 'student'): ?>
                    <a href="<?php echo e(route('downloads')); ?>"
                        class="<?php echo e(Route::currentRouteName() === 'downloads' ? 'underline text-[#9D3E3E]' : 'hover:text-[#9D3E3E]'); ?> text-sm font-semibold">
                        Downloadable Forms
                    </a>
                <?php endif; ?>
            <?php endif; ?>
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('user.dashboard')); ?>"
                    class="<?php echo e(Route::currentRouteName() === 'user.dashboard' ? 'underline text-[#9D3E3E]' : 'hover:text-[#9D3E3E]'); ?> text-sm font-semibold">
                    Submit Thesis
                </a>
            <?php endif; ?>
            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->account_type !== 'faculty'): ?>
                    <a href="<?php echo e(route('user.dashboard')); ?>"
                        class="<?php echo e(Route::currentRouteName() === 'user.dashboard' ? 'underline text-[#9D3E3E]' : 'hover:text-[#9D3E3E]'); ?> text-sm font-semibold">
                        Submit Thesis
                    </a>
        ...
        <div class="hidden md:block">
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>" class="text-sm font-semibold hover:text-[#9D3E3E]">
                    Login
                </a>
            <?php endif; ?>
                ...
                <div class="group relative flex items-center space-x-4">
                    <div class="flex cursor-pointer items-center">
                        <span class="text-sm font-semibold">
                            Welcome, <?php echo e(Auth::user()->decrypted_first_name); ?>
                    ...
                    <div
                        ...
                        <?php elseif(Auth::user()->account_type === 'faculty'): ?>
    ...
    <div id="mobile-menu" class="hidden px-4 pb-4 md:hidden">
        <div class="space-y-2">
            <a href="<?php echo e(route('home')); ?>" class="block text-sm font-semibold text-[#575757] hover:text-[#9D3E3E]">
                Home
            </a>
            <a href="https://sites.google.com/usep.edu.ph/ctet-ctsul-research-center/home" target="_blank"
            ...
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('user.dashboard')); ?>"
                    class="<?php echo e(Route::currentRouteName() === 'user.dashboard' ? 'underline text-[#9D3E3E]' : 'hover:text-[#9D3E3E]'); ?> block text-sm font-semibold text-[#575757] hover:text-[#9D3E3E]">
                    Submit Thesis
                </a>
            <?php endif; ?>
            <?php if(auth()->guard()->check()): ?>
            ...
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('login')); ?>" class="block text-sm font-semibold text-[#575757] hover:text-[#9D3E3E]">
                    Login
                </a>
            <?php endif; ?>

            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(Auth::user()->hasPermission('view-dashboard') ? route('admin.dashboard') : (Auth::user()->account_type === 'faculty' ? route('faculty.dashboard') : route('user.dashboard'))); ?>"
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/layout-partials/landing-header.blade.php ENDPATH**/ ?>