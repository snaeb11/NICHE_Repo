...
<div id="import-excel-popup" style="display: none;"
    ...
    <div
        class="bg-[#fdfdfd] w-[90vw] sm:w-[80vw] md:w-[60vw] lg:w-[30vw] max-h-[90vh] rounded-2xl shadow-xl relative p-4 sm:p-6 overflow-y-auto">
        ...
        <div class="w-full">
            <div
                class="flex flex-col sm:flex-row sm:items-center sm:justify-start justify-center items-center mt-3 sm:space-x-4 space-y-2 sm:space-y-0">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1"
                    stroke="currentColor" class="w-16 h-16 sm:w-20 sm:h-20 text-gray-700">
        ...
        <div id="ie-step-1" class="flex justify-center mt-6">
            <div
                class="flex flex-col items-center w-full border-dashed border-[1px] border-[#575757] rounded-xl p-4 space-y-3">
                ...
                <button id="ie-browse-btn-1"
                    class="w-full sm:w-[60%] rounded-lg bg-[#fdfdfd] text-[#575757] font-semibold hover:brightness-95 border border-[#575757] py-2 transition-all duration-200">
                    Browse
                </button>
        ...
        <div id="ie-step-2" class="hidden justify-center mt-6">
            <div
                class="flex flex-col items-center w-full border-dashed border-[1px] border-[#575757] rounded-xl p-4 space-y-4">
                <div class="flex items-center justify-center space-x-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="#575757" class="w-8 h-8 sm:w-10 sm:h-10">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4 mt-4 w-full sm:w-[60%]">
                    ...
                    <button id="ie-confirm-btn"
                        class="flex-1 rounded-full text-white bg-gradient-to-r from-[#28CA0E] to-[#1BA104] hover:from-[#3ceb22] hover:to-[#2db415] py-2 transition-all duration-200">
                        Confirm
                    </button>
                </div>
            </div>
