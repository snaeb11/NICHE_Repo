            ...
            <div
                ...
                <aside id="logo-sidebar" class="h-full overflow-y-auto px-3 py-4 text-white">
                    <div class="flex items-center space-x-3 text-[#fffff0]">
                        ...
                        <div
                            class="invisible whitespace-nowrap opacity-0 transition-opacity duration-300 group-hover:visible group-hover:opacity-100">
                            <a href="#" class="username-admin block font-semibold hover:underline">User Name</a>
    ...
    <div id="mobile-sidebar"
        class="fixed left-0 top-0 z-50 h-screen w-64 -translate-x-full transform bg-gradient-to-b from-[#D56C6C] to-[#C96262] transition-transform duration-300 md:hidden"
        ...
        <aside class="h-full overflow-y-auto px-3 py-4 text-white">
            <aside id="logo-sidebar" class="h-full overflow-y-auto px-3 py-4 text-white">
                <div class="flex items-center space-x-3 text-[#fffff0]">
                    ...
                    <div class="ms-3 whitespace-nowrap transition-opacity duration-300">
                        <a href="#" class="username-admin block font-semibold hover:underline">User Name</a>
                        <div class="text-sm font-light">Admin Title</div>
                    </div>
                    <button type="button"
