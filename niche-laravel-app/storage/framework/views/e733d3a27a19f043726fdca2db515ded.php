<div id="logout-popup" style="display: none;"
    ...
    <div
        ...
        <div class="mt-8 sm:mt-10 flex flex-col-reverse sm:flex-row justify-center gap-3 sm:gap-5">
            ...
            <form id="logout-form" method="POST" action="<?php echo e(route('logout')); ?>" class="w-full sm:w-auto">
                <?php echo csrf_field(); ?>
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/popups/logout-m.blade.php ENDPATH**/ ?>