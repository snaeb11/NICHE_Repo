<div id="faculty-edit-acc-success" style="display: none;"
    ...
    <div class="relative max-h-[90vh] min-w-[21vw] max-w-[25vw] rounded-2xl bg-[#fdfdfd] p-8 shadow-xl">
        ...
        <div class="mt-10 text-center text-xl font-semibold">
            <span class="text-[#575757]">Faculty profile updated successfully!</span>
        </div>
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/popups/faculty-edit-acc-success.blade.php ENDPATH**/ ?>