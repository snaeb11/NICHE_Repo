<div id="login-failed-popup" style="display: none;" class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
    <div class="min-w-[21vw] max-w-[25vw] max-h-[90vh] bg-[#fffff0] rounded-2xl shadow-xl relative p-8">
        ...
        <div class="text-center mt-5 text-normal font-regular">
            <span class="text-[#575757]">Press try again.</span>
        </div>

        <div class="mt-13 flex justify-center">
            <button id="lf-confirm-btn" class="px-10 py-4 rounded-full text-[#fffff0] bg-gradient-to-r from-[#FF5656] to-[#DF0606] shadow hover:brightness-110 cursor-pointer">
                Confirm
            </button>
        </div>
    </div>
