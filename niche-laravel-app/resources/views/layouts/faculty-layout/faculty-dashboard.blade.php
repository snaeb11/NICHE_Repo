...
@section('childContent')
            ...
            <div id="faculty-dashboard" class="pb-15 flex w-full max-w-screen-xl flex-col gap-6 p-4 pt-10 md:flex-row">
                ...
                <div class="flex w-full flex-col space-y-2 md:w-1/2">
                    <div class="flex items-center justify-between">
                        <span class="text-3xl font-semibold text-[#575757]">Form Submissions</span>
                        <div class="space-x-2">
                            <button id="faculty-add-submission-btn"
                                class="rounded bg-gradient-to-r from-[#D56C6C] to-[#9D3E3E] px-2 py-1 text-sm font-semibold text-[#fdfdfd] shadow hover:brightness-110">Submit</button>
                            <button id="faculty-history-btn"
                                class="rounded bg-gradient-to-r from-[#FFC360] to-[#FFA104] px-2 py-1 text-sm font-semibold text-[#fdfdfd] shadow hover:brightness-110">Track</button>
                        </div>
                    </div>
    ...
    <div id="faculty-history-container" class="mx-auto hidden w-full max-w-screen-2xl flex-grow bg-[#fdfdfd]">
        <!-- faculty history table -->
        <main id="faculty-history-table" class="flex w-full flex-col pt-10 transition-all duration-300 ease-in-out">
