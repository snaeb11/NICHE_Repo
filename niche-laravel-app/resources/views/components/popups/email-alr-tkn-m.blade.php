    ...
    <div class="w-full max-w-md max-h-[90vh] bg-[#fdfdfd] rounded-2xl shadow-xl relative p-6 sm:p-8 overflow-y-auto">
        ...
        <div class="flex justify-center mt-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" 
                ...
                class="h-16 w-16 sm:h-20 sm:w-20"> <!-- 🔹 CHANGED: responsive icon size -->
        ...
        <!-- Title -->
        <div class="text-center text-lg font-semibold mt-6 sm:mt-10 sm:text-xl"><!-- 🔹 CHANGED -->
            <span class="text-[#575757]">Signup failed.</span>
        </div>

        <!-- Message -->
        <div class="text-center mt-4 text-sm font-light text-[#575757] sm:mt-5 sm:text-base"><!-- 🔹 CHANGED -->
            Email already taken. Please try again.
        </div>

        <!-- Button -->
        <div class="mt-8 flex justify-center sm:mt-13"><!-- 🔹 CHANGED -->
