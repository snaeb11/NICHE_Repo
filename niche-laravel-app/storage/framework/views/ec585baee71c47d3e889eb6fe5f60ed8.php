...
<?php if(session('success')): ?>
    <script>
        ...
        kSubText.textContent = "<?php echo e(session('success')); ?>";
...
<?php if(auth()->user()->hasPermission('view-backup')): ?>
    ...
    <?php if(auth()->user()->hasPermission('view-backup')): ?>
        <div class="flex items-center justify-center px-4">
            <div
                ...
                <form action="<?php echo e(route('admin.backup.reset')); ?>" method="post" class="w-full" id="backupAndResetForm">
                    <?php echo csrf_field(); ?>

                    <?php if(auth()->user()->hasPermission('download-backup')): ?>
                ...
                <form id="backup-form" action="<?php echo e(route('admin.backup.download')); ?>" method="get" class="w-full">
                    <?php if(auth()->user()->hasPermission('download-backup')): ?>
                ...
                <!-- Restore Section -->
                <?php if(auth()->user()->hasPermission('allow-restore')): ?>
                    ...
                    <!-- Restore Form -->
                    <form id="restore-form" action="<?php echo e(route('admin.backup.restore')); ?>" method="post"
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/admin-pages/backup-page.blade.php ENDPATH**/ ?>