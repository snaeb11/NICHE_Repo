...
<main id="submission-table" class="ml-[4vw] hidden p-8 transition-all duration-300 ease-in-out group-hover:ml-[18vw]">
    <div class="mb-4 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <?php if(auth()->user() && auth()->user()->hasPermission('view-submissions')): ?>
            <div class="w-full">
        ...
        <table class="min-w-full divide-y divide-gray-200">
            <thead class="bg-[#fdfdfd]">
                <tr>
                    ...
                    <?php if(auth()->user()->hasPermission('acc-rej-submissions')): ?>
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/admin-pages/submission-page.blade.php ENDPATH**/ ?>