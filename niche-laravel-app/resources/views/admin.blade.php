  ...
  if (subBody) {
    subBody.innerHTML += generateRows(20, () => `
      <tr>
        ...
        <td class="px-6 py-4 whitespace-nowrap"><button class="text-blue-600 hover:underline">Edit</button><button class="text-red-600 hover:underline ml-2">Delete</button></td>
      </tr>
    `);
  }
    ...
    usersBody.innerHTML += generateRows(20, () => {
      ...
      return `
        <tr>
          ...
          <td class="px-6 py-4 whitespace-nowrap"><button class="text-green-600 hover:underline">Edit</button><button class="text-red-600 hover:underline ml-2">Delete</button></td>
        </tr>
      `;
    });
  }
  ...
  if (backupTable) {
    backupTable.innerHTML += generateRows(15, () => `
      <tr>
        ...
        <td class="px-6 py-4 whitespace-nowrap">${randomDate()}</td>
        <td class="px-6 py-4 whitespace-nowrap">${randomName()}</td>
        <td class="px-6 py-4 whitespace-nowrap"><button class="text-green-600 hover:underline">Download</button></td>
      </tr>
    `);
  }
...
<body class="bg-[#fffff0] text-gray-900">
    ...
    <main id="submission-table" class="ml-[4vw] group-hover:ml-[18vw] transition-all duration-300 ease-in-out p-8 hidden">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex space-x-4">
                <!-- Program Dropdown -->
                <select class="px-4 py-2 rounded-lg text-[#575757] bg-white border border-gray-300 focus:outline-none focus:ring focus:ring-[#FFA104]">
                ...
                <!-- History Button -->
                <button class="px-4 py-2 rounded-lg text-[#fffff0] bg-gradient-to-r from-[#FFC360] to-[#FFA104] shadow hover:brightness-110">
                    History
                </button>
            </div>
        </div>
        ...
        <div class="overflow-x-auto bg-[#fffff0] shadow rounded-lg p-4">
            ...
            <div id="pagination-controls-submission" class="flex justify-end mt-4 space-x-2">
                <button onclick="changePage('submission', -1)" class="px-3 py-1 bg-gray-300 rounded hover:bg-gray-400"><</button>
    ...
    <main id="inventory-table" class="ml-[4vw] group-hover:ml-[18vw] transition-all duration-300 ease-in-out p-8 hidden">
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex space-x-4">
                ...
                <!-- Button -->
                <button class="px-4 py-2 rounded-lg text-[#fffff0] bg-gradient-to-r from-[#CE6767] to-[#A44444] shadow hover:brightness-110">
                    Add
                </button>
                ...
                <button class="px-4 py-2 rounded-lg text-[#fffff0] bg-gradient-to-r from-[#27C50D] to-[#1CA405] shadow hover:brightness-110">
                    Export
                </button>
            </div>
        </div>
        ...
        <div class="overflow-x-auto bg-[#fffff0] shadow rounded-lg p-4">
            ...
            <div id="pagination-controls-inventory" class="flex justify-end mt-4 space-x-2">
                <button onclick="changePage('inventory', -1)" class="px-3 py-1 bg-gray-300 rounded hover:bg-gray-400">&lt;</button>
    ...
    <main id="users-table" class="ml-[4vw] group-hover:ml-[18vw] transition-all duration-300 ease-in-out p-8 hidden">
        ...
        <div class="overflow-x-auto bg-[#fffff0] shadow rounded-lg p-4">
            ...
            <div id="pagination-controls-users" class="flex justify-end mt-4 space-x-2">
                <button onclick="changePage('users', -1)" class="px-3 py-1 bg-gray-300 rounded hover:bg-gray-400">&lt;</button>
    ...
    <main id="backup-table" class="ml-[4vw] group-hover:ml-[18vw] transition-all duration-300 ease-in-out p-8 hidden">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody id="backup-table-body" class="bg-[#fffff0]] divide-y divide-gray-200 text-[#575757]">
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">Mark Cuban</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <button class="text-green-600 hover:underline">Download</button>
                        </td>
                </tbody>
            </table>
        </div>
        ...
        <div id="pagination-controls-backup" class="flex justify-end mt-4 space-x-2">
            <button onclick="changePage('backup', -1)" class="px-3 py-1 bg-gray-300 rounded hover:bg-gray-400">&lt;</button>
...
function sortTable(header) {
    ...
    showPage(tableKey, 1); // Reset to first page after sorting
}
...
document.addEventListener('DOMContentLoaded', () => {
  ['users', 'submission', 'inventory', 'logs', 'backup'].forEach(id => showPage(id, 1));
});
</script>
