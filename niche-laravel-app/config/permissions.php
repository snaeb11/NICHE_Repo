...
return [
    ...
    'admin' => ['view-dashboard', 'view-thesis-submissions', 'view-forms-submissions', 'acc-rej-thesis-submissions', 'acc-rej-forms-submissions', 'view-inventory', 'add-inventory', 'edit-inventory', 'export-inventory', 'view-accounts', 'view-logs', 'modify-programs-list', 'modify-advisers-list'],
