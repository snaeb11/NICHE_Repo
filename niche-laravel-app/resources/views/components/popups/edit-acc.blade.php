<div id="edit-account-popup" style="display: none;" class="fixed inset-0 flex items-center justify-center bg-black/50 z-50 px-2 sm:px-0">
  <div id="ea-step1" class="w-full max-w-[95vw] sm:min-w-[52svw] sm:max-w-[60vw] max-h-[90vh] bg-[#fdfdfd] rounded-2xl shadow-xl relative p-4 sm:p-8 overflow-y-auto">
    ...
    <div class="text-center mt-5 text-2xl sm:text-3xl font-semibold">
  ...
  <div id="ea-step2" class="w-full max-w-[90vw] sm:min-w-[20vw] sm:max-w-[25vw] max-h-[90vh] bg-[#fdfdfd] rounded-2xl shadow-xl relative p-4 sm:p-8 hidden overflow-y-auto">
    <div class="flex justify-center mt-0">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="#575757" class="w-20 h-20">
    ...
    <div class="text-center mt-5 text-sm font-regular">
