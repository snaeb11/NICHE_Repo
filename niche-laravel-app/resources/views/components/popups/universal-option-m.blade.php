<div id="universal-option-popup" style="display: none;" class="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
    <div id="option-popup" class="w-[70vw] md:min-w-[20vw] md:max-w-[25vw] max-h-[90vh] bg-[#fffff0] rounded-2xl shadow-xl relative p-6 md:p-8 block">
        ...
        <div class="ml-3 mr-3 mt-20 flex flex-col md:flex-row justify-center space-y-3 md:space-y-0 md:space-x-5">
            <button id="uniOpt-cancel-btn" class="px-10 py-4 rounded-full text-[#fffff0] bg-gradient-to-r from-[#707070] to-[#a5a5a5] shadow hover:brightness-110 cursor-pointer">
                Cancel
            </button>
            <button id="uniOpt-confirm-btn" class="px-10 py-4 rounded-full text-[#fffff0] bg-gradient-to-r from-[#27C50D] to-[#1CA506] shadow hover:brightness-110 cursor-pointer">
                Confirm
            </button>
        </div>
    </div>
