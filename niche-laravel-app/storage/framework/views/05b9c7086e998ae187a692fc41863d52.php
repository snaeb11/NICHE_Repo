        ...
        <div
            ...
            <aside id="logo-sidebar" class="h-full px-3 py-4 text-white">
                ...
                <ul class="space-y-2 font-medium">
                    <li class="mt-10"></li>
                    <?php if(auth()->user()->hasPermission('view-thesis-submissions')): ?>
                        <li>
                    ...
                    <?php if(auth()->user()->hasPermission('view-forms-submissions')): ?>
                        <li>
                    ...
                    <?php if(auth()->user()->hasPermission('view-accounts')): ?>
                        <li>
                            <a href="#" id="users-tab"
                                class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-[#e97b7b] dark:text-white dark:hover:bg-[#e97b7b]">
                    ...
                    <?php if(auth()->user()->hasPermission('view-logs')): ?>
                        <li>
                            <a href="#" id="logs-tab"
                                class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-[#e97b7b] dark:text-white dark:hover:bg-[#e97b7b]">
                    ...
                    <?php if(auth()->user()->hasPermission('modify-programs-list') || auth()->user()->hasPermission('modify-advisers-list')): ?>
                        <li class="pt-2">
                            <div
                        ...
                        <?php if(auth()->user()->hasPermission('modify-programs-list')): ?>
                            <li>
                        ...
                        <?php endif; ?>
                        <?php if(auth()->user()->hasPermission('modify-advisers-list')): ?>
                            <li>
                        ...
                        <?php endif; ?>
                        <?php if(auth()->user()->hasPermission('modify-downloadable-forms')): ?>
                            <li>
...
<?php /**PATH /home/vunc/Documents/HR_Repo/HR_Repo/niche-laravel-app/resources/views/components/shared/new-sidebar.blade.php ENDPATH**/ ?>